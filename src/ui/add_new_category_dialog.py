...
# Form implementation generated from reading ui file '/home/kubus/Pulpit/Wydatkoinator/ui/add_new_category_dialog.ui'
#
...
"}")
        ...
        self.buttonBox.accepted.connect(add_category_dialog.accept)
        self.buttonBox.rejected.connect(add_category_dialog.reject)
